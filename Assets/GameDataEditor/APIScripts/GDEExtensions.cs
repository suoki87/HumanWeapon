...
{
    static string StripToSchema(string type)
    {
    ...
    {
        return StripToSchema(typeof(T).Name);
    }
    ...
    public static string SchemaName (this string variable)
    {
        return StripToSchema(variable);
    }
}
...
public static class DictionaryExtensions
{
    ...
    public static T TryGetEnum<TKey, TValue, T> (this Dictionary<TKey, TValue> variable,  TKey key, T value) where T : struct, IConvertible
    {
        value = default (T);
        ...
        {
            TValue origValue;
            if (variable.TryGetValue(key, out origValue))
                value = (T)Enum.Parse(typeof(T), origValue.ToString());
        }
        catch
        {
        }
    ...
    public static List<T> TryGetEnumList<TKey, TValue, T> (this Dictionary<TKey, TValue> variable, TKey key, List<T> value) where T : struct, IConvertible
    {
        ...
        {
            if (variable.TryGetList (key, out tempList))
                value = tempList.ConvertAll (obj => (T)Enum.Parse(typeof(T), obj.ToString()));
        }
        catch (Exception ex)
        {
    ...
    public static List<List<T>> TryGetEnumTwoDList<TKey, TValue, T> (this Dictionary<TKey, TValue> variable, TKey key, List<List<T>> value) where T : struct, IConvertible
    {
        ...
        try 
        {
            ...
            if (variable.TryGetList (key, out tempList))
            {
                ...
                foreach (object entry in tempList) {
                    List<object> tempSubList = entry as List<object>;
                    enum_list = tempSubList.ConvertAll (obj => (T)Enum.Parse(typeof(T), obj.ToString()));
                    value.Add (enum_list);
                }
            }
        }
    ...
    public static bool TryGetVideoClip<TKey, TValue> (this Dictionary<TKey, TValue> variable, TKey key, out VideoClip value)
    {
        return variable.TryGetUnityType<TKey, TValue, VideoClip> (key, out value);
    }

    public static bool TryGetVideoClipList<TKey, TValue> (this Dictionary<TKey, TValue> variable, TKey key, out List<VideoClip> value)
    {
        return variable.TryGetUnityTypeList<TKey, TValue, VideoClip> (key, out value);
    }

    public static bool TryGetVideoClipTwoDList<TKey, TValue> (this Dictionary<TKey, TValue> variable, TKey key, out List<List<VideoClip>> value)
    {
        return variable.TryGetUnityTypeTwoDList<TKey, TValue, VideoClip> (key, out value);
    }
