...
public partial class GDEDataManager
{
    ...
    static Dictionary<string, HashSet<string>> _dataKeysBySchema = null;
    static Dictionary<string, HashSet<string>> DataKeysBySchema {
        get
        {
            if (_dataKeysBySchema == null)
                _dataKeysBySchema = new Dictionary<string, HashSet<string>>();
            return _dataKeysBySchema;
        }
        set
        {
            _dataKeysBySchema = value;
        }
    }
