...
public class GDMConstants
{
	...
	public const string ErrorConfigNotSet = "Please enter your GDE Online Config Settings in GDEOConfig.cs!";
	#endregion
	...
	public const string VideoClipActionTooltip = "Gets a VideoClip from a GDE Item";
	public const string GetEnumActionTooltip = "Gets an Enum from a GDE Item";
	...
	public const string GetVideoClipCustomActionTooltip = "Gets a VideoClip from a GDE Custom Item";
	public const string GetEnumCustomActionTooltip = "Gets an Enum from a GDE Custom Item";
	...
	public const string GetVideoClipListActionTooltip = "Gets a VideoClip Array from a GDE Item";
	public const string GetEnumListActionTooltip = "Gets an Enum Array from a GDE Item";
	...
	public const string GetVideoClipListCustomActionTooltip = "Gets a VideoClip Array from a GDE Custom Item";
	...
	public const string GetEnumListCustomActionTooltip = "Gets an Enum Array from a GDE Custom Item";
	...
	public const string VideoClipCustomFieldTooltip = "The field name of the VideoClip inside the custom item.";
	public const string EnumCustomFieldTooltip = "The field name of the Enum inside the custom item.";
	...
	public const string VideoClipListCustomFieldTooltip = "The field name of the VideoClip Array inside the custom item.";
	public const string EnumListCustomFieldTooltip = "The field name of the Enum Array inside the custom item.";
	...
	public const string SetEnumActionTooltip = "Sets an Enum on a GDE Item";
	...
	public const string SetEnumArrayActionTooltip = "Sets an Enum Array on a GDE Item";
	...
	public const string SetCustomEnumActionTooltip = "Sets an Enum on a GDE Custom Item";
	...
	public const string SetCustomEnumArrayActionTooltip = "Sets an Enum Array on a GDE Custom Item";
#endif
	#endregion
}
}
