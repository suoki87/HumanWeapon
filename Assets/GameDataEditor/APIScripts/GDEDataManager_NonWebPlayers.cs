...
public partial class GDEDataManager
{
	...
	public static T GetEnum<T>(string key, string field, T defaultVal) where T : Enum
	{
		T retVal = defaultVal;
	...
	public static List<T> GetEnumList<T>(string key, string field, List<T> defaultVal = null) where T : Enum
	{
	...
	public static List<List<T>> GetEnumTwoDList<T>(string key, string field, List<List<T>> defaultVal = null) where T : Enum
	{
	...
	public static void SetEnum<T>(string key, string field, T val) where T : Enum
	{
		try
		{
			SaveValue(key, field, val);
	...
	public static void SetEnumList<T>(string key, string field, List<T> val) where T : Enum
	{
		try
		{
			SaveValue(key, field, val);
	...
	public static void SetEnumTwoDList<T>(string key, string field, List<List<T>> val) where T : Enum
	{
		try
		{
			SaveValue(key, field, val);
