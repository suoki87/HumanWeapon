...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip(GDMConstants.SetCustomBoolArrayActionTooltip)]
	public class GDESetCustomBoolArray : GDESetActionBase
	{   
		[UIHint(UIHint.FsmString)]
		[Tooltip(GDMConstants.BoolListCustomFieldTooltip)]
		...
		public override void OnEnter()
		{
			...
			{	
				...
				GDEDataManager.SetBoolList(customKey, CustomField.Value, vals);
			}
