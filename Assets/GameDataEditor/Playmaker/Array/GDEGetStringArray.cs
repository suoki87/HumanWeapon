...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Gets a String Array from a GDE Item")]
	public class GDEGetStringArray : GDEActionBase
	{
		...
		public override void OnEnter()
		{
			try
			{
				...
				val = GDEDataManager.GetStringList(ItemName.Value, FieldName.Value, val);
