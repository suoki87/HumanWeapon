...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip(GDMConstants.SetCustomVec3ArrayActionTooltip)]
	public class GDESetCustomVector3Array : GDESetActionBase
	{   
		...
		public override void OnEnter()
		{
			...
			{	
				...
				GDEDataManager.SetVector3List(customKey, CustomField.Value, vals);
			}
