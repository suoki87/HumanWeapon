...
namespace GameDataEditor
{
    public class GDEConstants
    {
		...
		public const string VersionLbl = "Version: " + Version;
        #endregion
        ...
        public const string ResetBtn = "Reset";
		...
		public const string LoadGDEOBtn = "Load From GDE Online";
		#endregion
        ...
        public const string BasicFieldTypeLbl = "Basic Field:";
        public const string CustomFieldTypeLbl = "Custom Field:";
		...
		public const string AllLbl = "All";
        ...
        public const string PlaymakerSupportMenu = "Playmaker Support/";
        public const string iCodeSupportMenu = "iCode Support/";
        public const string EnableMenu = "Enable";
        public const string DisableMenu = "Disable";
        public const string PMArray = " Array Actions";
        public const string PMRequired = " (Requires Playmaker 1.8+)";
        public const string EnablePMArrays = EnableMenu + PMArray + PMRequired;
        public const string DisablePMArrays = DisableMenu + PMArray;
        public const string ClearModDataMenu = "Clear GDE Runtime Data";
		public const string EncryptMenu = "Encrypt Data";
		public const string GDEOUploadPrimaryMenu = "Upload Data To GDEO";
		public const string ClearExcelMenu = "Clear Spreadsheet Settings";
		...
		public const string RuntimeValuesLbl = "Show Runtime Values";
        public const string RuntimeVarValLbl = "Runtime Value:";
        public const string AddCustomEnumFieldBtn = "Add Custom Enum Field";
        public const string CustomEnumFieldTypeLbl = "Custom Enum:";
        public const string TryGDEOLink = "Try GDE Online (Free Service)";
        public const string GDEOMenuLbl = "GDE Online";
        #endregion
        ...
        public const string SizeRuntimeValuesLblKey = "67" + KeySuffix;
        public const string SizeRuntimeVarValLblKey = "68" + KeySuffix;
        public const string SizeResetBtnKey = "69" + KeySuffix;
        public const string SizeAddCustomEnumFieldBtn = "70" + KeySuffix;
        public const string SizeCustomEnumFieldTypeLbl = "71" + KeySuffix;
        public const string SizeTryGDEOLinkKey = "72" + KeySuffix;
        public const string SizeLoadGDEOBtnKey = "73" + KeySuffix;
		#endregion
        ...
        public const string RuntimeKeyPrefix = "rt_";
        ...
        #region Processor Defines
        public const string PMSymbol = "GDE_PLAYMAKER_SUPPORT";
        #endregion
		...
		public const string SettingsFile = "gde_editor_settings.bytes";
		public const string SettingsPath = "Editor/" + SettingsFile;
		public const string DataFile = "gde_data.txt";
		#endregion

		#region Link Strings
		public const string RateMeText = "Rate (Please)!";
		...
		public const string GDEOUrl = "http://gdeonline.solutions";
		#endregion
